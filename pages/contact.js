...
const Contact = () => {
  ...
  return (
    <Layout>
      <InnerPageLayout title="Dejanos tus Datos para contactarnos Contigo" />
          ...
          <div className="container">
            <div className="row">
              ...
              <div className="col-lg-8">
                <form id="contact-form" action="https://formspree.io/f/meqypbwq"
        ...
        <div className="modal-dialog" role="document">
          <div className="modal-content">
            <div className="modal-header">
              <h5 className="modal-title">Gracias Newlands se Comunicará Contigo</h5>
